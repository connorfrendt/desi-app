const phoneOptionOne = document.getElementById('option-1');
const phoneOptionTwo = document.getElementById('option-2');
const phoneOptionThr = document.getElementById('option-3');
const dropdown = document.getElementById('dropdown');


let userInput = [];
function fetchPhoneType(phoneOption) {
    ...
    fetch(phoneOption)
        ...
        .then(data => {
            ...
            let outerContainer = '';
            outerContainer = document.getElementById('outer-box');
